    ...
    return (
        <div id="navId" className="navbar">
            <div className="navLogo">
                <img className="logoImg" src="./images/fabriklogo.png" alt="" />
            </div>
            <NavDefault/>
            ...
            <div onClick = {navOn} id = "hamLogoId" className="hamLogo">
                <img className="hamImg" src="./images/hamburgermenu.png" alt="" />
            </div>
            <div onClick = {navOff} id="closeNavLogoId" className="closeNavLogo">
                <img className="hamImg" src="./images/upicon.png" alt="" />
            </div>
        </div>
    )
